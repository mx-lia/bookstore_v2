    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavouriteBooks", x => new { x.BookISBN, x.CustomerId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookGenres", x => new { x.BookISBN, x.GenreId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookPublishers", x => new { x.BookISBN, x.PublisherId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavouriteBooks_CustomerId",
